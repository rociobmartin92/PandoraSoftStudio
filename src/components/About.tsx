export const About = () => {
  return (
    ...
    >
      ...
      <p className="text-xl font-black sm:font-semibold  sm:text-lg line-height: 7rem">
      ...
      <p className="mt-6 text-xl font-black sm:font-semibold sm:text-lg line-height: 7rem">
